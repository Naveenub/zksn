...
│   └── scripts/            # Seed node bootstrap scripts
│
├── scripts/                # Utility scripts
│   └── gen-identity.sh     # Keypair generation
│
├── CONTRIBUTING.md
├── SECURITY.md
├── LICENSE
