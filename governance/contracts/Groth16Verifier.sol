...
contract Groth16Verifier is IVerifier {
     ...
     */
    function verifyProof(bytes calldata proof, uint256[4] calldata signals) external view override returns (bool) {
        // ── decode ────────────────────────────────────────────────────────────
    ...
    function _g1Mul(uint256 px, uint256 py, uint256 s) internal view returns (uint256 rx, uint256 ry) {
    ...
    function _g1Add(uint256 ax, uint256 ay, uint256 bx, uint256 by) internal view returns (uint256 rx, uint256 ry) {
     ...
     */
    function _pairingCheck(uint256[2] memory a, uint256[2][2] memory b, uint256 vx, uint256 vy, uint256[2] memory c)
        internal
        view
        returns (bool)
    {
